...
public class RandomStudentPanel extends JPanel {
    ...
    private Map<String, Integer> scores = new HashMap<>();  // 添加成员变量
    ...
    public RandomStudentPanel() {
        ...
        btnAbsence.addActionListener(e -> {
            ...
            try {
                ...
                // 扣分
                updateStudentScore(selectedClass, studentName, -Constant.ABSENTEEISM_SCORE);  // 缺勤扣5分
                JOptionPane.showMessageDialog(this, "已记录缺勤并扣除5分", "", JOptionPane.INFORMATION_MESSAGE);
        ...
        btnLeave.addActionListener(e -> {
            ...
            try {
                ...
                // 扣分
                updateStudentScore(selectedClass, studentName, -Constant.LEAVE_SCORE);  // 请假扣2分
                JOptionPane.showMessageDialog(this, "已记录请假并扣除2分", "", JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(this, 
        ...
        btnAnswer.addActionListener(e -> {
            ...
            try {
                // 更新学生分数
                updateStudentScore(selectedClass, studentName, Constant.ANSWER_QUESTION);  // 回答正确加3分
                JOptionPane.showMessageDialog(this, "回答正确，加3分！", "", JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(this, 
                    "更新分数失败：" + ex.getMessage(), 
                    "错误", 
                    JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    private void updateStudentScore(String className, String studentName, int scoreChange) throws IOException {
        ...
        int newScore = Math.max(0, Math.min(100, currentScore + scoreChange));  // 确保分数在0-100之间
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(scoreFile))) {
            for (Map.Entry<String, Integer> entry : scores.entrySet()) {
                ...
                writer.println(String.join(",", parts[0], parts[1], String.valueOf(entry.getValue())));
            }
        }
    }
}
